...
class SecretsDetector:
    ...
    def scan(self, content: str, file_path: str) -> List[Finding]:
        ...
        for pattern in self.patterns:
            ...
            remediation = pattern.get("remediation", "Do not hardcode secrets. Use environment variables or secure vaults.")
            ...
            try:
                ...
                for match in compiled.finditer(content):
                    ...
                    finding = Finding(
                        ...
                        description=f"Found {name} secret: {match.group(0)[:50]}...",
                        file_path=file_path,
                        line_number=line,
                        severity=severity,
                        cvss_score=7.5,  # Default high
